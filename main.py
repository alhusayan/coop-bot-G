...
2. سوّ بحث حي (Live Web Search) الآن عن سعره الحالي في الكويت — ركز على:
   المنصات الإلكترونية الكويتية (جمعية دوت كوم jm3eia، توصيل Taw9eel، لولو الكويت، كارفور الكويت، سيتي هايبر، هاي آند باي HiandBuy، سلطان سنتر، جراند هايبر، أونكوست OnCost، ماي يو MyU، أسواق الميرة).
