...
app = FastAPI()
BUILD_ID = "v70-1-english-search-arabic-display-20260804"
print("=" * 70)
print(f"STARTING COOP BOT BUILD: {BUILD_ID}")
print("SEARCH IN ENGLISH -> DISPLAY IN ARABIC + SHOPPING + CATEGORY ENGINE")
print("=" * 70)
...
@app.get("/")
async def health(): return {"status":"v70 ENGLISH SEARCH -> ARABIC DISPLAY + SHOPPING + CATEGORY ENGINE", "build":BUILD_ID, "location_ttl_hours":LOCATION_TTL_SECONDS//3600}
